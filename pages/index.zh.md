...
您可以在 [apps.obtainium.page](https://apps.obtainium.page) 上找到基于众包的应用配置。

如果找不到想要的应用配置，请随时在[讨论页](https://github.com/ImranR98/apps.obtainium.page/discussions/new?category=app-requests)上提出议题请求。

或者，在[此项目仓库](https://github.com/ImranR98/apps.obtainium.page)上创建拉取请求，为网站贡献一些配置。
